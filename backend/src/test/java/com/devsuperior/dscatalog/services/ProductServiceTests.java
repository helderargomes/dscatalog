...
public class ProductServiceTests {
	...
	void setUp() throws Exception {
		...
		Mockito.when(categoryRepository.getReferenceById(existingCatId)).thenReturn(category);
	...
	public void updateShouldReturnProductDTOWhenIdExists() {
		...
		Mockito.verify(categoryRepository).getReferenceById(existingCatId);
	}
	...
	public void findByIdShouldThrowsResourceNotFoundExceptionWhenIdDoesNotExist() {
		...
		Assertions.assertThrows(ResourceNotFoundException.class, () -> {
			productDto = service.findById(nonExistingId);
		});
